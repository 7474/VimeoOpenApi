...
namespace VimeoOpenApi.Model
{
    ...
    public partial class InlineObject10 :  IEquatable<InlineObject10>, IValidatableObject
    {
        ...
        public InlineObject10(string text = default(string))
        {
            // to ensure "text" is required (not null)
            this.Text = text ?? throw new ArgumentNullException("text is a required property for InlineObject10 and cannot be null");
        }
