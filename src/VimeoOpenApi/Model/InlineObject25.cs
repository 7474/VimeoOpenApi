...
namespace VimeoOpenApi.Model
{
    ...
    public partial class InlineObject25 :  IEquatable<InlineObject25>, IValidatableObject
    {
        ...
        public InlineObject25(string name = default(string))
        {
            // to ensure "name" is required (not null)
            this.Name = name ?? throw new ArgumentNullException("name is a required property for InlineObject25 and cannot be null");
        }
