...
namespace VimeoOpenApi.Model
{
    ...
    public partial class UserMetadata :  IEquatable<UserMetadata>, IValidatableObject
    {
        ...
        public UserMetadata(UserMetadataConnections connections = default(UserMetadataConnections), UserMetadataInteractions interactions = default(UserMetadataInteractions))
        {
            // to ensure "connections" is required (not null)
            this.Connections = connections ?? throw new ArgumentNullException("connections is a required property for UserMetadata and cannot be null");
            // to ensure "interactions" is required (not null)
            this.Interactions = interactions ?? throw new ArgumentNullException("interactions is a required property for UserMetadata and cannot be null");
        }
