...
namespace VimeoOpenApi.Model
{
    ...
    public partial class InlineObject11 :  IEquatable<InlineObject11>, IValidatableObject
    {
        ...
        public InlineObject11(string email = default(string), string name = default(string), string role = default(string), string userUri = default(string))
        {
            // to ensure "email" is required (not null)
            this.Email = email ?? throw new ArgumentNullException("email is a required property for InlineObject11 and cannot be null");
            // to ensure "name" is required (not null)
            this.Name = name ?? throw new ArgumentNullException("name is a required property for InlineObject11 and cannot be null");
            // to ensure "role" is required (not null)
            this.Role = role ?? throw new ArgumentNullException("role is a required property for InlineObject11 and cannot be null");
            // to ensure "userUri" is required (not null)
            this.UserUri = userUri ?? throw new ArgumentNullException("userUri is a required property for InlineObject11 and cannot be null");
        }
