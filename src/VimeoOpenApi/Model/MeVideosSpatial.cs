...
namespace VimeoOpenApi.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class MeVideosSpatial :  IEquatable<MeVideosSpatial>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="MeVideosSpatial" /> class.
        /// </summary>
        ...
        public MeVideosSpatial(List<MeVideosSpatialDirectorTimeline> directorTimeline = default(List<MeVideosSpatialDirectorTimeline>), decimal fieldOfView = default(decimal), ProjectionEnum? projection = default(ProjectionEnum?), StereoFormatEnum? stereoFormat = default(StereoFormatEnum?))
        {
        ...
        public List<MeVideosSpatialDirectorTimeline> DirectorTimeline { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class MeVideosSpatial {\n");
        ...
        {
            return this.Equals(input as MeVideosSpatial);
        }

        /// <summary>
        /// Returns true if MeVideosSpatial instances are equal
        /// </summary>
        /// <param name="input">Instance of MeVideosSpatial to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MeVideosSpatial input)
        {
            if (input == null)
                return false;
