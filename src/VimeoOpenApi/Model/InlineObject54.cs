...
namespace VimeoOpenApi.Model
{
    ...
    public partial class InlineObject54 :  IEquatable<InlineObject54>, IValidatableObject
    {
        ...
        /// Initializes a new instance of the <see cref="InlineObject54" /> class.
        /// </summary>
        /// <param name="text">The text of the comment. (required).</param>
        public InlineObject54(string text = default(string))
        {
            // to ensure "text" is required (not null)
            this.Text = text ?? throw new ArgumentNullException("text is a required property for InlineObject54 and cannot be null");
        }
