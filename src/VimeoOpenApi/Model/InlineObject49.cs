...
namespace VimeoOpenApi.Model
{
    ...
    public partial class InlineObject49 :  IEquatable<InlineObject49>, IValidatableObject
    {
        ...
        public InlineObject49(string name = default(string))
        {
            // to ensure "name" is required (not null)
            this.Name = name ?? throw new ArgumentNullException("name is a required property for InlineObject49 and cannot be null");
        }
