...
namespace VimeoOpenApi.Model
{
    ...
    public partial class InlineObject4 :  IEquatable<InlineObject4>, IValidatableObject
    {
        ...
        /// Initializes a new instance of the <see cref="InlineObject4" /> class.
        /// </summary>
        /// <param name="userUri">The URI of a user to remove as a moderator. (required).</param>
        public InlineObject4(string userUri = default(string))
        {
            // to ensure "userUri" is required (not null)
            this.UserUri = userUri ?? throw new ArgumentNullException("userUri is a required property for InlineObject4 and cannot be null");
        }
        
        /// <summary>
        /// The URI of a user to remove as a moderator.
        /// </summary>
        /// <value>The URI of a user to remove as a moderator.</value>
