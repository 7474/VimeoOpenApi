...
{
    /// <summary>
    /// OndemandPagesOndemandIdVideosVideoIdBuyPrice
    /// </summary>
    [DataContract]
    public partial class OndemandPagesOndemandIdVideosVideoIdBuyPrice :  IEquatable<OndemandPagesOndemandIdVideosVideoIdBuyPrice>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="OndemandPagesOndemandIdVideosVideoIdBuyPrice" /> class.
        /// </summary>
        ...
        /// <param name="uSD">The purchase price of the video in United States dollars. This field is required when **buy.active** is &#x60;true&#x60;..</param>
        public OndemandPagesOndemandIdVideosVideoIdBuyPrice(decimal aUD = default(decimal), decimal cAD = default(decimal), decimal cHF = default(decimal), decimal dKK = default(decimal), decimal eUR = default(decimal), decimal gBP = default(decimal), decimal jPY = default(decimal), decimal kRW = default(decimal), decimal nOK = default(decimal), decimal pLN = default(decimal), decimal sEK = default(decimal), decimal uSD = default(decimal))
        {
            this.AUD = aUD;
            this.CAD = cAD;
            this.CHF = cHF;
        ...
        /// <summary>
        /// The purchase price of the video in United States dollars. This field is required when **buy.active** is &#x60;true&#x60;.
        /// </summary>
        /// <value>The purchase price of the video in United States dollars. This field is required when **buy.active** is &#x60;true&#x60;.</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class OndemandPagesOndemandIdVideosVideoIdBuyPrice {\n");
        ...
        {
            return this.Equals(input as OndemandPagesOndemandIdVideosVideoIdBuyPrice);
        }

        /// <summary>
        /// Returns true if OndemandPagesOndemandIdVideosVideoIdBuyPrice instances are equal
        /// </summary>
        /// <param name="input">Instance of OndemandPagesOndemandIdVideosVideoIdBuyPrice to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OndemandPagesOndemandIdVideosVideoIdBuyPrice input)
        {
            if (input == null)
                return false;
