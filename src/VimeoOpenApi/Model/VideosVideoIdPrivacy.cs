...
{
    /// <summary>
    /// VideosVideoIdPrivacy
    /// </summary>
    [DataContract]
    public partial class VideosVideoIdPrivacy :  IEquatable<VideosVideoIdPrivacy>, IValidatableObject
    {
        /// <summary>
        ...
        /// </summary>
        /// <value>The privacy level required to comment on the video.  Option descriptions:  * &#x60;anybody&#x60; - Anyone can comment on the video.  * &#x60;contacts&#x60; - Only the owner&#39;s contacts can comment on the video.  * &#x60;nobody&#x60; - No one can comment on the video. </value>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="VideosVideoIdPrivacy" /> class.
        /// </summary>
        /// <param name="add">Whether a user can add the video to a showcase, channel, or group..</param>
        /// <param name="comments">The privacy level required to comment on the video.  Option descriptions:  * &#x60;anybody&#x60; - Anyone can comment on the video.  * &#x60;contacts&#x60; - Only the owner&#39;s contacts can comment on the video.  * &#x60;nobody&#x60; - No one can comment on the video. .</param>
        ...
        public VideosVideoIdPrivacy(bool add = default(bool), CommentsEnum? comments = default(CommentsEnum?), bool download = default(bool), EmbedEnum? embed = default(EmbedEnum?), ViewEnum? view = default(ViewEnum?))
        {
            this.Add = add;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class VideosVideoIdPrivacy {\n");
        ...
        {
            return this.Equals(input as VideosVideoIdPrivacy);
        }

        /// <summary>
        /// Returns true if VideosVideoIdPrivacy instances are equal
        /// </summary>
        /// <param name="input">Instance of VideosVideoIdPrivacy to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(VideosVideoIdPrivacy input)
        {
            if (input == null)
                return false;
