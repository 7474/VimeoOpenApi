...
namespace VimeoOpenApi.Model
{
    ...
    public partial class InlineObject45 :  IEquatable<InlineObject45>, IValidatableObject
    {
        ...
        public InlineObject45(AcceptedCurrenciesEnum? acceptedCurrencies = default(AcceptedCurrenciesEnum?), MeOndemandPagesBuy buy = default(MeOndemandPagesBuy), ContentRatingEnum contentRating = default(ContentRatingEnum), string description = default(string), string domainLink = default(string), MeOndemandPagesEpisodes episodes = default(MeOndemandPagesEpisodes), string link = default(string), string name = default(string), MeOndemandPagesRent rent = default(MeOndemandPagesRent), MeOndemandPagesSubscription subscription = default(MeOndemandPagesSubscription), TypeEnum type = default(TypeEnum))
        {
            this.ContentRating = contentRating;
            // to ensure "description" is required (not null)
            this.Description = description ?? throw new ArgumentNullException("description is a required property for InlineObject45 and cannot be null");
            // to ensure "name" is required (not null)
            this.Name = name ?? throw new ArgumentNullException("name is a required property for InlineObject45 and cannot be null");
            this.Type = type;
