...
namespace VimeoOpenApi.Model
{
    ...
    public partial class InlineObject62 :  IEquatable<InlineObject62>, IValidatableObject
    {
        ...
        public InlineObject62(bool active = default(bool), string language = default(string), string name = default(string), TypeEnum type = default(TypeEnum))
        {
            // to ensure "language" is required (not null)
            this.Language = language ?? throw new ArgumentNullException("language is a required property for InlineObject62 and cannot be null");
            // to ensure "name" is required (not null)
            this.Name = name ?? throw new ArgumentNullException("name is a required property for InlineObject62 and cannot be null");
            this.Type = type;
            this.Active = active;
        }
