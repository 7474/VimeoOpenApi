...
namespace VimeoOpenApi.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class AlbumMetadata :  IEquatable<AlbumMetadata>, IValidatableObject
    {
        /// <summary>
        ...
        public AlbumMetadata(AlbumMetadataConnections connections = default(AlbumMetadataConnections), AlbumMetadataInteractions interactions = default(AlbumMetadataInteractions))
        {
            // to ensure "connections" is required (not null)
            this.Connections = connections ?? throw new ArgumentNullException("connections is a required property for AlbumMetadata and cannot be null");
            // to ensure "interactions" is required (not null)
            this.Interactions = interactions ?? throw new ArgumentNullException("interactions is a required property for AlbumMetadata and cannot be null");
        }
        ...
        {
            return this.Equals(input as AlbumMetadata);
        }

        /// <summary>
        /// Returns true if AlbumMetadata instances are equal
        /// </summary>
        /// <param name="input">Instance of AlbumMetadata to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AlbumMetadata input)
        {
            if (input == null)
                return false;
