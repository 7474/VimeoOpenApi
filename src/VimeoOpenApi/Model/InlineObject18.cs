...
namespace VimeoOpenApi.Model
{
    ...
    public partial class InlineObject18 :  IEquatable<InlineObject18>, IValidatableObject
    {
        ...
        public InlineObject18(string videos = default(string))
        {
            // to ensure "videos" is required (not null)
            this.Videos = videos ?? throw new ArgumentNullException("videos is a required property for InlineObject18 and cannot be null");
        }
