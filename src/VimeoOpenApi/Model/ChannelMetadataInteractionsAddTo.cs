...
namespace VimeoOpenApi.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ChannelMetadataInteractionsAddTo :  IEquatable<ChannelMetadataInteractionsAddTo>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ChannelMetadataInteractionsAddTo" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ChannelMetadataInteractionsAddTo() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ChannelMetadataInteractionsAddTo" /> class.
        /// </summary>
        ...
        public ChannelMetadataInteractionsAddTo(List<string> options = default(List<string>), string uri = default(string))
        {
            // to ensure "options" is required (not null)
            this.Options = options ?? throw new ArgumentNullException("options is a required property for ChannelMetadataInteractionsAddTo and cannot be null");
            // to ensure "uri" is required (not null)
            this.Uri = uri ?? throw new ArgumentNullException("uri is a required property for ChannelMetadataInteractionsAddTo and cannot be null");
        }
        ...
        {
            return this.Equals(input as ChannelMetadataInteractionsAddTo);
        }

        /// <summary>
        /// Returns true if ChannelMetadataInteractionsAddTo instances are equal
        /// </summary>
        /// <param name="input">Instance of ChannelMetadataInteractionsAddTo to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ChannelMetadataInteractionsAddTo input)
        {
            if (input == null)
                return false;
