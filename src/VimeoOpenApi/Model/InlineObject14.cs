...
namespace VimeoOpenApi.Model
{
    ...
    public partial class InlineObject14 :  IEquatable<InlineObject14>, IValidatableObject
    {
        ...
        public InlineObject14(string description = default(string), string name = default(string))
        {
            // to ensure "name" is required (not null)
            this.Name = name ?? throw new ArgumentNullException("name is a required property for InlineObject14 and cannot be null");
