...
namespace VimeoOpenApi.Model
{
    ...
    public partial class InlineObject37 :  IEquatable<InlineObject37>, IValidatableObject
    {
        ...
        public InlineObject37(string bio = default(string), List<string> contentFilter = default(List<string>), GenderEnum? gender = default(GenderEnum?), string link = default(string), string location = default(string), string name = default(string), string password = default(string), MeVideos videos = default(MeVideos))
        {
            this.Bio = bio;
