...
namespace VimeoOpenApi.Api
{
    ...
    /// </summary>
    public interface IVideosCreativeCommonsApiSync : IApiAccessor
    {
        ...
        /// <returns>List&lt;CreativeCommons&gt;</returns>
        ...
        ApiResponse<List<CreativeCommons>> GetCcLicensesWithHttpInfo ();
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface IVideosCreativeCommonsApiAsync : IApiAccessor
    {
        ...
        /// </remarks>
        /// <exception cref="VimeoOpenApi.Client.ApiException">Thrown when fails to make API call</exception>
        /// <returns>Task of List&lt;CreativeCommons&gt;</returns>
        System.Threading.Tasks.Task<List<CreativeCommons>> GetCcLicensesAsync ();
        ...
        /// </remarks>
        /// <exception cref="VimeoOpenApi.Client.ApiException">Thrown when fails to make API call</exception>
        /// <returns>Task of ApiResponse (List&lt;CreativeCommons&gt;)</returns>
        System.Threading.Tasks.Task<ApiResponse<List<CreativeCommons>>> GetCcLicensesAsyncWithHttpInfo ();
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface IVideosCreativeCommonsApi : IVideosCreativeCommonsApiSync, IVideosCreativeCommonsApiAsync
    {
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public partial class VideosCreativeCommonsApi : IVideosCreativeCommonsApi
    {
        private VimeoOpenApi.Client.ExceptionFactory _exceptionFactory = (name, response) => null;

        /// <summary>
        /// Initializes a new instance of the <see cref="VideosCreativeCommonsApi"/> class.
        /// </summary>
        /// <returns></returns>
        public VideosCreativeCommonsApi() : this((string) null)
        {
        }
        ...
        /// </summary>
        /// <returns></returns>
        public VideosCreativeCommonsApi(String basePath)
        {
        ...
        /// <returns></returns>
        public VideosCreativeCommonsApi(VimeoOpenApi.Client.Configuration configuration)
        {
        ...
        public VideosCreativeCommonsApi(VimeoOpenApi.Client.ISynchronousClient client,VimeoOpenApi.Client.IAsynchronousClient asyncClient, VimeoOpenApi.Client.IReadableConfiguration configuration)
        {
        ...
        /// <exception cref="VimeoOpenApi.Client.ApiException">Thrown when fails to make API call</exception>
        /// <returns>List&lt;CreativeCommons&gt;</returns>
        public List<CreativeCommons> GetCcLicenses ()
        {
             VimeoOpenApi.Client.ApiResponse<List<CreativeCommons>> localVarResponse = GetCcLicensesWithHttpInfo();
        ...
        /// <exception cref="VimeoOpenApi.Client.ApiException">Thrown when fails to make API call</exception>
        /// <returns>Task of List&lt;CreativeCommons&gt;</returns>
        public async System.Threading.Tasks.Task<List<CreativeCommons>> GetCcLicensesAsync ()
        {
             VimeoOpenApi.Client.ApiResponse<List<CreativeCommons>> localVarResponse = await GetCcLicensesAsyncWithHttpInfo();
             return localVarResponse.Data;
        ...
        /// <exception cref="VimeoOpenApi.Client.ApiException">Thrown when fails to make API call</exception>
        /// <returns>Task of ApiResponse (List&lt;CreativeCommons&gt;)</returns>
        public async System.Threading.Tasks.Task<VimeoOpenApi.Client.ApiResponse<List<CreativeCommons>>> GetCcLicensesAsyncWithHttpInfo ()
        {
            ...
            var localVarResponse = await this.AsynchronousClient.GetAsync<List<CreativeCommons>>("/creativecommons", localVarRequestOptions, this.Configuration);
