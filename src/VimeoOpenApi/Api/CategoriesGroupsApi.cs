...
namespace VimeoOpenApi.Api
{
    ...
    /// </summary>
    public interface ICategoriesGroupsApiSync : IApiAccessor
    {
        ...
        List<Group> GetCategoryGroups (string category, string direction = default(string), decimal? page = default(decimal?), decimal? perPage = default(decimal?), string query = default(string), string sort = default(string));
        ...
        ApiResponse<List<Group>> GetCategoryGroupsWithHttpInfo (string category, string direction = default(string), decimal? page = default(decimal?), decimal? perPage = default(decimal?), string query = default(string), string sort = default(string));
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface ICategoriesGroupsApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task<List<Group>> GetCategoryGroupsAsync (string category, string direction = default(string), decimal? page = default(decimal?), decimal? perPage = default(decimal?), string query = default(string), string sort = default(string));
        ...
        System.Threading.Tasks.Task<ApiResponse<List<Group>>> GetCategoryGroupsAsyncWithHttpInfo (string category, string direction = default(string), decimal? page = default(decimal?), decimal? perPage = default(decimal?), string query = default(string), string sort = default(string));
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface ICategoriesGroupsApi : ICategoriesGroupsApiSync, ICategoriesGroupsApiAsync
    {
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public partial class CategoriesGroupsApi : ICategoriesGroupsApi
    {
        private VimeoOpenApi.Client.ExceptionFactory _exceptionFactory = (name, response) => null;

        /// <summary>
        /// Initializes a new instance of the <see cref="CategoriesGroupsApi"/> class.
        /// </summary>
        /// <returns></returns>
        public CategoriesGroupsApi() : this((string) null)
        {
        }
        ...
        /// </summary>
        /// <returns></returns>
        public CategoriesGroupsApi(String basePath)
        {
        ...
        /// <returns></returns>
        public CategoriesGroupsApi(VimeoOpenApi.Client.Configuration configuration)
        {
        ...
        public CategoriesGroupsApi(VimeoOpenApi.Client.ISynchronousClient client,VimeoOpenApi.Client.IAsynchronousClient asyncClient, VimeoOpenApi.Client.IReadableConfiguration configuration)
        {
        ...
        /// <param name="sort">The way to sort the results.  Option descriptions:  * &#x60;alphabetical&#x60; - Sort the results alphabetically.  * &#x60;date&#x60; - Sort the results by date.  * &#x60;members&#x60; - Sort the results by number of members.  * &#x60;videos&#x60; - Sort the results by number of videos.  (optional)</param>
        /// <returns>ApiResponse of List&lt;Group&gt;</returns>
        public VimeoOpenApi.Client.ApiResponse< List<Group> > GetCategoryGroupsWithHttpInfo (string category, string direction = default(string), decimal? page = default(decimal?), decimal? perPage = default(decimal?), string query = default(string), string sort = default(string))
        {
            // verify the required parameter 'category' is set
            if (category == null)
                throw new VimeoOpenApi.Client.ApiException(400, "Missing required parameter 'category' when calling CategoriesGroupsApi->GetCategoryGroups");
            ...
            var localVarResponse = this.Client.Get< List<Group> >("/categories/{category}/groups", localVarRequestOptions, this.Configuration);

            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("GetCategoryGroups", localVarResponse);
        ...
        /// <param name="sort">The way to sort the results.  Option descriptions:  * &#x60;alphabetical&#x60; - Sort the results alphabetically.  * &#x60;date&#x60; - Sort the results by date.  * &#x60;members&#x60; - Sort the results by number of members.  * &#x60;videos&#x60; - Sort the results by number of videos.  (optional)</param>
        /// <returns>Task of ApiResponse (List&lt;Group&gt;)</returns>
        public async System.Threading.Tasks.Task<VimeoOpenApi.Client.ApiResponse<List<Group>>> GetCategoryGroupsAsyncWithHttpInfo (string category, string direction = default(string), decimal? page = default(decimal?), decimal? perPage = default(decimal?), string query = default(string), string sort = default(string))
        {
            // verify the required parameter 'category' is set
            if (category == null)
                throw new VimeoOpenApi.Client.ApiException(400, "Missing required parameter 'category' when calling CategoriesGroupsApi->GetCategoryGroups");
            ...
            var localVarResponse = await this.AsynchronousClient.GetAsync<List<Group>>("/categories/{category}/groups", localVarRequestOptions, this.Configuration);
