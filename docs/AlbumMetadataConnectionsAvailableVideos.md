# VimeoOpenApi.Model.AlbumMetadataConnectionsAvailableVideos
...
**Total** | **decimal** | The total number of videos on this connection. This data requires a bearer token with the &#x60;private&#x60; scope. | 
