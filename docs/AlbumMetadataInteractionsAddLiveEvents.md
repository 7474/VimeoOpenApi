# VimeoOpenApi.Model.AlbumMetadataInteractionsAddLiveEvents
An action indicating that the authenticated user is an administrator of the showcase and may therefore add live events. This data requires a bearer token with the `private` scope.
## Properties
